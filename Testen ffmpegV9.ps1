...
ffmpeg -i output.mp4 -i .\stereo1.mp3 -i .\stereo2.mp3 -i .\stereo3.mp3 -i .\stereo4.mp3 -map 0:v -map 1:a -map 2:a -map 3:a -map 4:a -c copy -shortest $Script:newvid -y
}

# Move item naar Export map en open Exportmap
function MoveItems() {
Move $Script:newvid $location -Force
